...
describe('Service Tests', () => {
    ...
    describe('ShoppingMySuffix Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(ShoppingMySuffixService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/shoppings';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return ShoppingMySuffix', () => {
