...
describe('Service Tests', () => {
    ...
    describe('TypeClothesMySuffix Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(TypeClothesMySuffixService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/type-clothes';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return TypeClothesMySuffix', () => {
