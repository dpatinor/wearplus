...
describe('Service Tests', () => {
    ...
    describe('ClothesMySuffix Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(ClothesMySuffixService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/clothes';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return ClothesMySuffix', () => {
